...
function maelmc_get_atlas_and_pos(name)
  ...
  local atlas_prefix = pokermon.sprites.get_atlas_prefix(name, sprite_info)
  local atlas = "poke_"..pokermon.sprites.get_atlas_string(atlas_prefix, sprite_info.gen_atlas, sprite_info.others_atlas)
